const recipes = [
    ...
    },
    {
        ...
        "time": 80,
        "description":"Émincer les blanc de poireaux et les faire chauffer dans 25 g de beurre. AJouter les pommes de terres coupées en morceaux. Ajouter l'eau et laisser mijoter pour 45 minutes. Chauffer l'oseille avec le beurre restant puis incorporer le tout. Mixez. Ajoutez la crème. Bon appetit.",
        "appliance": "Mixer",
...
// const ingredients = recipes.find(el => el.ingredients === [3]);
// const ingredients=recipes[3].ingredients;
// recipeData.innerHTML += `
// <article class="users">
//   ${recipes.map(recipe => `
//     <p>${recipe.name} a ${ingredients} points</p>`).join('')}
// </article>
// `;
// console.log(ingredients);
// const recipeData = document.querySelector('#recipesHome');
// const ingredientsData = recipes.slice();
// recipes.forEach(recipe => {

//         recipeData.innerHTML += `
//                         <article class="recipeCard"${recipe.id}>
...
//                                         <p>${recipes[3].ingredient}:${ingredientsData.quantity}${ingredientsData.time}</p>
//                                         </div>
...
objProps(recipes).forEach(objProp => {

        recipeData.innerHTML += `
                        <article class="recipeCard"${objProp.id}>
                                <div class="recipePic"></div>
                                <div class="recipeInfo">
                                    <div class="recipeTitle">
                                        <h2>${objProp.name}</h2>
                                        <div class="recipeTime">
                                            <i class="far fa-clock"></i>
                                            <p>${objProp.time} min</p>
                                        </div>
                                    </div>
                                    <div class="recipeDetails">
                                        <div class="ingredients">
                                        <p>${objProp.ingredient}:${objProp.quantity}${ingredientsData.time}</p>
                                        </div>
                                        <div class="description">
                                            <p class="productDescription">${objProp.description}</p>
                                        </div>
                                    </div>
                                </div>
                        </article>
